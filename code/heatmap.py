...
def get_params():
    params = {
        'weight':  r'/home/xgq/Desktop/yolo/runs/train/exp6/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    # model(r'C:\Users\18084\Desktop\yolo\YOLO\ultralytics-yolo11-20250502\ultralytics-yolo11-main\dataset\6.2\images\val', 'result')
    model(r"/home/xgq/Desktop/yolo/YOLO/ultralytics-yolo11-20250502/ultralytics-yolo11-main/dataset/6.2/images/val/(1607).JPG", 'result')